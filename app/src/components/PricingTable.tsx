...
export const PricingTable: React.FC<PricingTableProps> = ({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 md:p-8 bg-white dark:bg-gray-800 rounded-lg">
      <div className="text-center mb-12">
        <Zap className="mx-auto h-12 w-12 sm:h-16 sm:w-16 text-purple-500 mb-4" />
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 dark:text-white tracking-tight mb-2">{headline}</h1>
        <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">{subheadline}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start">
        {/* Column 1: Self-Hosted */}
        <div className="border dark:border-gray-600 rounded-lg p-6 flex flex-col h-full bg-gray-50/50 dark:bg-gray-700/50 shadow-sm">
          <div className="text-center">
            <HardDrive className="mx-auto h-10 w-10 text-gray-500 dark:text-gray-400 mb-3" />
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Self-Hosted</h2>
            <p className="text-gray-500 dark:text-gray-400 min-h-[4rem]">Maximum privacy & control on your own hardware.</p>
          </div>
          <ul className="space-y-4 my-8 flex-grow text-gray-800 dark:text-gray-200">
          ...
          <a href="https://github.com/Roy3838/Observer?tab=readme-ov-file#option-1-full-docker-setup-recommended--easiest" target="_blank" rel="noopener noreferrer" className="w-full text-center mt-auto px-6 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            View Setup Guide
          </a>
        </div>

        {/* Column 2: Observer Cloud (Free Tier) - Now with dynamic state */}
        <div className={`border dark:border-gray-600 rounded-lg p-6 flex flex-col h-full bg-white dark:bg-gray-700 shadow-md ${isTriggeredByQuotaError ? 'border-amber-400 dark:border-amber-500 border-2' : ''}`}>
           {isTriggeredByQuotaError && <div className="text-center font-bold text-amber-600 dark:text-amber-400 mb-2">Your Current Plan</div>}
          <div className="text-center">
            <Server className="mx-auto h-10 w-10 text-gray-500 dark:text-gray-400 mb-3" />
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Observer Cloud</h2>
            <p className="text-gray-500 dark:text-gray-400 min-h-[4rem]">Get started instantly with our cloud infrastructure. Great for light use.</p>
          </div>
          <ul className="space-y-4 my-8 flex-grow text-gray-800 dark:text-gray-200">
            ...
            {isTriggeredByQuotaError ? (
                <li className="flex items-start font-semibold text-red-600 dark:text-red-400"><AlertTriangle className="h-6 w-6 text-red-500 mr-3 flex-shrink-0" /><span><strong>Daily Usage:</strong> Limit Reached</span></li>
            ) : (
        ...
        <div className="relative border-2 border-purple-500 dark:border-purple-400 rounded-lg p-6 flex flex-col h-full bg-purple-50 dark:bg-purple-900/20 shadow-lg">
          ...
          <div className="text-center">
            <Sparkles className="mx-auto h-10 w-10 text-purple-500 dark:text-purple-400 mb-3" />
            <h2 className="text-2xl font-bold text-purple-800 dark:text-purple-200">Observer Pro</h2>
            <p className="text-purple-700 dark:text-purple-300 min-h-[4rem]">The ultimate experience. Unleash the full power and support the project's future.</p>
          </div>
          <ul className="space-y-4 my-8 flex-grow text-purple-800 dark:text-purple-200">
            ...
            <li className="flex items-start"><Check className="h-6 w-6 text-green-500 mr-3 flex-shrink-0" /><span><strong>Daily Usage:</strong> ∞ Unlimited</span></li>
            <li className="flex items-start"><Check className="h-6 w-6 text-green-500 mr-3 flex-shrink-0" /><span><strong>Premium Cloud Models</strong> <span className='text-xs bg-purple-200 dark:bg-purple-700 text-purple-700 dark:text-purple-200 rounded-full px-2 py-1 ml-1'>Coming Soon</span></span></li>
